...
<section class="dashboard">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <?php
            $select_instruments = mysqli_query($conn, "SELECT * FROM `products`") or die('query failed');
            $number_of_instruments = mysqli_num_rows($select_instruments);
         ?>
         <h3><?php echo $number_of_instruments; ?></h3>
         <p>instruments added</p>
      </div>
